...
mpirun -n 4 python main_prune.py --cr 0.25 --name run1-prune --seed 101 --epochs 200
mpirun -n 4 python main_prune.py --cr	0.25 --name run2-prune --seed 102 --epochs 200
mpirun -n 4 python main_prune.py --cr	0.25 --name run3-prune --seed 103 --epochs 200