#!/usr/bin/env bash
#SBATCH --job-name=prune0.1    # sets the job name if not set from environment
...
mpirun -n 4 python main_prune.py --cr 0.1 --name run1-sketch --seed 101 --epochs 200
mpirun -n 4 python main_prune.py --cr	0.1 --name run2-sketch --seed 102 --epochs 200
mpirun -n 4 python main_prune.py --cr	0.1 --name run3-sketch --seed 103 --epochs 200